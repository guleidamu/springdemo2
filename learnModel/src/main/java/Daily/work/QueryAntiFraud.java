...
class BspAPI {
    ...
    /* Basic request URL */
    private static final String URL = "af.tencentcloudapi.com/";
    ...
    private static String encode(byte[] bstr){
        ...
        return Base64.getEncoder().encodeToString(bstr).replaceAll(sp, "");
    }
...
//        System.out.println("Signature: >>> " + arguments.get("Signature"));
...
/* Demo section */
public class QueryAntiFraud {

    public static void main(String[] argv) throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException
    {
        final String SECRET_ID = "AKIDmWRBjC02F73qUxPSI0bhdTGx8sUxlRzP";
        final String SECRET_KEY = "PeUCpIfyCMQQGfz9A7cx645wcBew31tN";

        Map<String, String> args = new TreeMap<String, String>();

        // 基本字段
//        args.put("IdNumber", "123456789011541547");
//        args.put("PhoneNumber", "13246208548");
        args.put("IdNumber", "123456789011541547");
        args.put("PhoneNumber", "13246208548");
        // 可选字段
        args.put("Name", "杨二红");
