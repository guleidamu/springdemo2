package com.springdemo.spring_jpa.config.datasource;
...
/**
 * @ Author     ：damu
 * @ Date       ：Created in 10:50 2020/7/16
 * @ Modified By：
 * @Version: 1.0.0
 */
@Configuration
@MapperScan(basePackages = "com.springdemo.spring_jpa.dao.second",sqlSessionTemplateRef ="secondSqlSessionTemplate")
